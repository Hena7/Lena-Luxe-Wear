...
export default function LoginPage() {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // IMPORTANT: Add logic here later to store session/token received from API
            // For now, just redirect to homepage after success
             alert(locale === 'am' ? 'በተሳካ ሁኔታ ገብተዋል!' : 'Login successful!'); // Simple confirmation
             await refetchUser(); // Get refetchUser function
                    ...
                    <div className="-space-y-px rounded-md shadow-sm">
                     ...
                     <div className="flex items-center justify-between">
                         <div className="text-sm">
                             <a href="#" className="font-medium m-3 text-purple-600 hover:text-purple-500 dark:text-purple-400 dark:hover:text-purple-300">
