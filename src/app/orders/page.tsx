...
// Includes nested items and product details within items
interface UserOrderView extends Order {
    items: (OrderItem & {
        product: Pick<Product, 'id' | 'name' | 'imageUrl'> | null; // Product might be null if deleted
    })[];
    // We don't necessarily expect the full User object here as it's the current user's orders
}
