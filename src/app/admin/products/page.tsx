...
// Define the shape of Product data returned by the admin API (includes category name)
interface AdminProductView extends Product {
    category: {
        name: string;
    } | null;
    _count?: { // Optional: If you included counts in API
        orderItems: number;
    };
}
                                         ...
                                         products.map((product) => (
                                             <tr key={product.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                                 ...
                                                 <td 
                                                      ...
                                                      className={`whitespace-nowrap px-3 py-4 text-sm text-center font-medium tabular-nums ${
                                                            product.stock < 10 ? 'text-orange-600 dark:text-orange-400' : 'text-gray-500 dark:text-gray-400'
                                                      }`}
                                                 >
                                                    {product.stock}
                                                  </td>
